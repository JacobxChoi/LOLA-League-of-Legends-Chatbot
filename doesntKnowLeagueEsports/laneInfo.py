def laneInfo():
    laneInfo = {
        ...
        '`So there are 3 lanes in League, and the 5 players on each team each fill 1 role and are distributed across those 3 lanes.`': {
            '[{3, three}, lanes]': {
                '`You may have heard about them, the lanes are Top, Middle (or Mid), and Bottom (or Bot). There\'s 1 player in each lane, and the last 2 '
                                    ...
                                    '[tank, tanks]': {
                                        ...
                                        '`Tanks excel in shrugging off incoming damage and focus on disrupting their enemies, protecting their allies in the process. Popular tanks include Malphite, Ornn, and Sion. Would you like to hear about a different lane?`': {
                                            ...
                                            '[{no, nah, nope, not really}]': {
                                                ...
                                                '`What would you like to know more about: the different types of champions, in-game objectives, or the map?`': {
